...
Added in Firmata protocol version 2.\+1.\+0.\hypertarget{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md29}{}\doxysubsection{I2\+C read/write request}\label{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md29}
...
{\itshape auto-\/restart (byte 3, bit 6) is needed by some devices such as the M\+M\+A8452Q accelerometer and the M\+P\+L3115\+As altimeter}\hypertarget{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md30}{}\doxysubsection{I2\+C reply}\label{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md30}
...
\DoxyCodeLine{n  END\_SYSEX (0XF7)}
\end{DoxyCode}
\hypertarget{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md31}{}\doxysubsection{I2\+C config}\label{md__g_1__arduino-workspace__firmata_protocol_i2c_autotoc_md31}
