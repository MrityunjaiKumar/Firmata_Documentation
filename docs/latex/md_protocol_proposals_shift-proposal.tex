...
\DoxyCodeLine{n+1 END\_SYSEX}
\end{DoxyCode}
\hypertarget{md_protocol_proposals_shift-proposal_autotoc_md78}{}\doxysection{Proposal B\+: shift in/out with config and latch support}\label{md_protocol_proposals_shift-proposal_autotoc_md78}
